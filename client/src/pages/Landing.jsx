      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">PhotoGallery Lite</h1>
            <p className="text-gray-600">
              Explore curated photography collections
            </p>
          </div>
          ...
          <div className="pt-4 border-t border-gray-200">
            <p className="text-center text-sm text-gray-500">
              Sign in to access the photo gallery and view analytics
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 bg-white rounded-lg shadow-md p-4">
          <h2 className="text-sm font-semibold text-gray-700 mb-2">What's inside:</h2>
